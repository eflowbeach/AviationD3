...
var envinfo = {"qx.application":"aviationd3.Application","qx.revision":"","qx.theme":"aviationd3.theme.Theme","qx.version":"4.1"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"aviationd3":{"resourceUri":"../source/resource","sourceUri":"../source/class"},"qx":{"resourceUri":"../../mwp/trunk/libs/qooxdoo-4.1-sdk/framework/source/resource","sourceUri":"../../mwp/trunk/libs/qooxdoo-4.1-sdk/framework/source/class","sourceViewUri":"https://github.com/qooxdoo/qooxdoo/blob/%{qxGitBranch}/framework/source/class/%{classFilePath}#L%{lineNumber}"}};
